...
public class UnlimitedSlider extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        MaywrWare.fontManager.drawString(" - " + setting.getName() + " " + ChatFormatting.GRAY + setting.getValue() + ChatFormatting.RESET + " +", x + 2F, y - 1F - TrollGui.getClickGui().getTextOffset(), getState() ? 0xFFFFFFFF : 0xFFAAAAAA);
    }
